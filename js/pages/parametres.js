  ...
  <div class="grid-2">
    <div class="card">
      ...
      <div style="display:flex;flex-direction:column;gap:10px;">
        ...
        <div class="form-group"><label>Numéro d'entreprise</label><input id="soc-siret" value="${p.siret||SOCIETE.siret||''}"></div>
        ...
        <div class="form-group"><label>Taux TVA (%)</label><input type="number" id="soc-taux" value="${p.taux_tva||SOCIETE.taux_tva||21}"></div>
...
async function _saveSociete() {
  const data = {
    ...
    taux_tva: parseFloat(document.getElementById('soc-taux').value)||21,
  };
  try {
